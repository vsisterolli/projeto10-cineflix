...
export default function MovieAvailablePlaces({data, setData}) {
    ...
    return(
        <AvailablePlacesStyled>
            ...
            <StyledReservateMovie data-identifier="reservation-btn" onClick={() => {
                if(data.reservatedSeats === undefined || data.reservatedSeats.size === 0) {
                    alert("Selecione pelo menos um assento.");
                    return;
                }
                else {console.log(data.reservatedSeats.size);navigate('/sucesso');}
                const objPOST = {
            ...
            }}>Reservar assento(s)</StyledReservateMovie>
...
const StyledReservateMovie = styled.button`
